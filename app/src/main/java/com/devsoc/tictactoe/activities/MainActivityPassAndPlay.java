...
import com.devsoc.tictactoe.databinding.ActivityMainPassAndPlayBinding;
...
public class MainActivityPassAndPlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.msg.setText(playerPreferences.getString("playerName", "Host"));
        binding.msg.append(getString(R.string.plays_first_as_x_text));
        ...
        binding.nextRoundBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (firstPlayer.equals(playerPreferences.getString("playerName", "Host"))){
                    binding.msg.setText(playerPreferences.getString("pnpGame:opponentName", "Friend"));
                    binding.msg.append(getString(R.string.plays_first_as_x_text));
    ...
    private void clickedButton(Button button) {
        ...
        if (win()){
            ...
            binding.msg.setVisibility(View.VISIBLE);
            binding.msg.setText(binding.turnTv.getText().toString());
            binding.msg.append(getString(R.string.win_string));
